...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'my.authentication_success_handler' => 'getMy_AuthenticationSuccessHandlerService',
            'my.logout_success_handler' => 'getMy_LogoutSuccessHandlerService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('foundation_js' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/foundation/foundation/js/vendor/modernizr.js'), 1 => ($this->targetDirs[2].'/../vendor/foundation/foundation/js/vendor/jquery.js'), 2 => ($this->targetDirs[2].'/../vendor/foundation/foundation/js/foundation.min.js'), 3 => ($this->targetDirs[2].'/../vendor/foundation/foundation/js/foundation/foundation.alert.js')), 1 => array(0 => '?yui_js'), 2 => array()), 'foundation_css' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/foundation/foundation/css/foundation.css')), 1 => array(0 => 'cssembed'), 2 => array()))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SitePagesBundle', ($this->targetDirs[2].'/Resources/SitePagesBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SitePagesBundle', ($this->targetDirs[3].'/src/Site/PagesBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SiteBlogBundle', ($this->targetDirs[2].'/Resources/SiteBlogBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SiteBlogBundle', ($this->targetDirs[3].'/src/Site/BlogBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['assetic.filter.uglifycss'] = $instance = new \Assetic\Filter\UglifyCssFilter('/var/www/sf.medzoner.com/app/Resources/node_modules/uglifycss/uglifycss', '/usr/local/bin/node');
    ...
    {
        $this->services['assetic.filter.uglifyjs2'] = $instance = new \Assetic\Filter\UglifyJs2Filter('/var/www/sf.medzoner.com/app/Resources/node_modules/uglify-js/bin/uglifyjs', '/usr/local/bin/node');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'cssembed' => 'assetic.filter.cssembed', 'yui_js' => 'assetic.filter.yui_js', 'uglifycss' => 'assetic.filter.uglifycss', 'uglifyjs2' => 'assetic.filter.uglifyjs2'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Site\BlogBundle\Twig\Extensions\SiteBlogExtension A Site\BlogBundle\Twig\Extensions\SiteBlogExtension instance.
     */
    protected function getBloggerBlog_Twig_ExtensionService()
    {
        return $this->services['blogger_blog.twig.extension'] = new \Site\BlogBundle\Twig\Extensions\SiteBlogExtension();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'pode7676', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Site/PagesBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Site/BlogBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Site/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Site\\PagesBundle\\Entity');
        $c->addDriver($b, 'Site\\BlogBundle\\Entity');
        $c->addDriver($b, 'Site\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('SitePagesBundle' => 'Site\\PagesBundle\\Entity', 'SiteBlogBundle' => 'Site\\BlogBundle\\Entity', 'SiteUserBundle' => 'Site\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_83ee9c58e1bf4c328093ea9b5f0de6fe6fb927879b925a9ab589cdd0d1ea637d');
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $a->setNamespace('sf2mongodb_default_83ee9c58e1bf4c328093ea9b5f0de6fe6fb927879b925a9ab589cdd0d1ea637d');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Site/PagesBundle/Document'))), 'Site\\PagesBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('SitePagesBundle' => 'Site\\PagesBundle\\Document'));
        ...
        $instance->setDefaultDB('medzoner');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Site\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('Site\\UserBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.entity_manager'), 'Site\\UserBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Site\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Site\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Site\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.entity_manager'), 'Site\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['liip_imagine.cache.signer'] = new \Liip\ImagineBundle\Imagine\Cache\Signer('asdBHwmI1hsjKjanJK2WD@wdnak');
    }
    ...
    /**
     * Gets the 'my.authentication_success_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Site\UserBundle\EventListener\AuthenticationSuccessHandler A Site\UserBundle\EventListener\AuthenticationSuccessHandler instance.
     */
    protected function getMy_AuthenticationSuccessHandlerService()
    {
        $this->services['my.authentication_success_handler'] = $instance = new \Site\UserBundle\EventListener\AuthenticationSuccessHandler($this->get('security.http_utils'), array(), $this);
    ...
    /**
     * Gets the 'my.logout_success_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Site\UserBundle\EventListener\LogoutSuccessHandler A Site\UserBundle\EventListener\LogoutSuccessHandler instance.
     */
    protected function getMy_LogoutSuccessHandlerService()
    {
        return $this->services['my.logout_success_handler'] = new \Site\UserBundle\EventListener\LogoutSuccessHandler($this->get('security.http_utils'), '/');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/group');
        ...
        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $d, $this->get('my.logout_success_handler'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $d, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('my.authentication_success_handler'), array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $n, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54e2661207ac4', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('medzoner');
        $a->setPassword('Pode767677');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('medzoner.com');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Site/PagesBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Site/BlogBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Site/BlogBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        ...
        $instance->addResource('yml', ($this->targetDirs[2].'/Resources/translations/messages.fr.yml'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'SitePagesBundle', 1 => 'SiteBlogBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Site/PagesBundle/Resources/views'), 'SitePages');
        $instance->addPath(($this->targetDirs[3].'/src/Site/BlogBundle/Resources/views'), 'SiteBlog');
        $instance->addPath(($this->targetDirs[3].'/src/Site/UserBundle/Resources/views'), 'SiteUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('asdBHwmI1hsjKjanJK2WD@wdnak');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Site\BlogBundle\Security\Firewall\WsseListener A Site\BlogBundle\Security\Firewall\WsseListener instance.
     */
    protected function getWsse_Security_Authentication_ListenerService()
    {
        return $this->services['wsse.security.authentication.listener'] = new \Site\BlogBundle\Security\Firewall\WsseListener($this->get('security.context'), $this->get('security.authentication.manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Site\BlogBundle\Security\Authentication\Provider\WsseProvider A Site\BlogBundle\Security\Authentication\Provider\WsseProvider instance.
     */
    protected function getWsse_Security_Authentication_ProviderService()
    {
        return $this->services['wsse.security.authentication.provider'] = new \Site\BlogBundle\Security\Authentication\Provider\WsseProvider('', (__DIR__.'/security/nonces'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SitePagesBundle' => 'Site\\PagesBundle\\SitePagesBundle',
                'SiteBlogBundle' => 'Site\\BlogBundle\\SiteBlogBundle',
                'SiteUserBundle' => 'Site\\UserBundle\\SiteUserBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'pode7676',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'medzoner.com',
            'mailer_user' => 'medzoner',
            'mailer_password' => 'Pode767677',
            'locale' => 'fr',
            ...
            'kernel.secret' => 'asdBHwmI1hsjKjanJK2WD@wdnak',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'medzoner.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'medzoner',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Pode767677',
            ...
            'assetic.filter.uglifycss.bin' => '/var/www/sf.medzoner.com/app/Resources/node_modules/uglifycss/uglifycss',
            ...
            'assetic.filter.uglifyjs2.bin' => '/var/www/sf.medzoner.com/app/Resources/node_modules/uglify-js/bin/uglifyjs',
            ...
            'site_blog.comments.latest_comment_limit' => 5,
            'site_blog.blog.max_articles_per_page' => 4,
            'my.authentication_success_handler.class' => 'Site\\UserBundle\\EventListener\\AuthenticationSuccessHandler',
            'my.logout_success_handler.class' => 'Site\\UserBundle\\EventListener\\LogoutSuccessHandler',
            ...
            'fos_user.model.user.class' => 'Site\\UserBundle\\Entity\\User',
            ...
            'fos_user.model.group.class' => 'Site\\UserBundle\\Entity\\Group',
